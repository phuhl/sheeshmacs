...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-block-begin-line ((t (:background ,bg1 :foreground ,fg1))))
   `(org-block-end-line ((t (:background ,bg1 :foreground ,fg1))))
   `(org-block ((t (:background ,bg2 :foreground ,fg1 :box nil))))
   `(org-done ((t (:foreground ,builtin :box nil :strike-through nil :weight bold))))
   `(org-todo ((t (:foreground ,func :box nil :weight bold))))
   `(org-verbatim ((t (:background ,bg2 :foreground ,fg1 :weight normal))))
   `(org-code ((,class (:background ,bg2 :foreground ,fg4))))
   `(org-document-title ((t (:inherit org-level-1 :underline nil :height 2.0))))
   `(org-level-1 ((t (:inherit default :foreground "#a1a1a1" :slant normal :weight bold :height 1.1 :width normal :foundry "outline" :family "Verdana"))))
   `(org-level-2 ((t (:inherit default :foreground "#929292" :slant normal :weight normal :height 1.25 :width normal :foundry "outline" :family "Verdana"))))
   `(org-level-3 ((t (:inherit default :foreground "#838383" :weight bold))))
   `(show-paren-match ((t (:background "cornflower blue"))))
   )
;  (let* ((base-font-color (face-foreground 'org-column nil 'default))
;         (base3-font-color (face-foreground 'org-agenda-structure  nil 'default))
;         (background-color (face-background 'org-column nil 'default))
...
(provide-theme 'at-night)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; at-night-theme.el ends here
