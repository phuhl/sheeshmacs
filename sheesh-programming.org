...
-       Switch places: =C-M-t= ....... =a |b= -> =b a|=
  ...
  (use-package smartparens
    ...
    (local-set-key (kbd "M-f") 'sp-down-sexp) ;; nach vorne hinein
    (local-set-key (kbd "M-b") 'sp-backward-down-sexp) ;; hach hinten hinein
    (local-set-key (kbd "C-M-f") 'sp-up-sexp) ;; nach vorne heraus
    (local-set-key (kbd "C-M-b") 'sp-backward-up-sexp) ;; hach hinten heraus
...
(local-set-key (kbd "C-M-G") 'sp-split-sexp)
(local-set-key (kbd "C-M-g") 'sp-join-sexp)
