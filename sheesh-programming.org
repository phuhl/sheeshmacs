...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package typescript-mode
    ...
    (add-hook
     ...
     #'(lambda ()
         (setup-cycle-quotes)
         (local-set-key (my-key "Mode hydra") 'hydra-typescript/body)))
    (require 'ansi-color)
    ...
    (defhydra hydra-typescript (:hint nil :color blue)
      "TS"
      ("sd" tide-documentation-at-point "Documentation at point" :column "Show")
      ("sr" tide-references "References")
      ("se" tide-error-at-point "Error at point")
      ("sE" tide-project-errors "Project errors")


      ("f" tide-fix "Fix")
      ("t" tide-add-tslint-disable-next-line "Add tslint-disable-next-line")
      ("R" tide-rename-symbol "Rename symbol" :column "Change")
      ("F" tide-rename-file "Rename file")
      ("r" tide-refactor "Refactor")
      ("i" tide-organize-imports "Organize-imports")
      ("C-r" tide-restart-server "Restart server" :column "Other")))
